...
public class FullTests
{
    ...
    public async Task Run()
    {
        ...
        await RunFormDataWrapperAndVerify([syntax], applicationMetadata);
    }

    static async Task RunFormDataWrapperAndVerify(SyntaxTree[] sources, string applicationMetadata)
    {
