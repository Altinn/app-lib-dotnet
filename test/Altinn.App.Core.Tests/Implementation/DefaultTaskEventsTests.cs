...
internal class DefaultTaskEvents
{
    public DefaultTaskEvents(params object[] fields)
    {
    }

    public async Task OnEndProcessTask(string s, Instance i)
    {
        await Task.CompletedTask;
    }

    public async Task OnStartProcessTask(string s, Instance i, Dictionary<string, string> p)
    {
        await Task.CompletedTask;
    }
}