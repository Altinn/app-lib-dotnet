...
public class ExpressionTests
{
    ...
    public void TestShortcuts()
    {
        ...
        Assert.Equal(trueExpression.ValueUnion, ExpressionValue.True);
        Assert.False(trueExpression.IsFunctionExpression);

        var falseExpression = Expression.False;
        Assert.Equal(falseExpression.ValueUnion, ExpressionValue.False);
        Assert.False(falseExpression.IsFunctionExpression);

        var nullExpression = Expression.Null;
        Assert.Equal(nullExpression.ValueUnion, ExpressionValue.Null);
