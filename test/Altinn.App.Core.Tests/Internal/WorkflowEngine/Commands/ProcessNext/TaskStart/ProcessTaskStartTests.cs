...
public class ProcessTaskStartTests
{
    private static ProcessEngineCommandContext CreateContext(Instance instance)
    {
        ...
        return new ProcessEngineCommandContext
        {
            ...
            {
                CommandKey = ProcessTaskStart.Key,
    ...
    private static ProcessTaskStart CreateCommand(IProcessTask processTask)
    {
        ...
        return new ProcessTaskStart(resolver);
    }
