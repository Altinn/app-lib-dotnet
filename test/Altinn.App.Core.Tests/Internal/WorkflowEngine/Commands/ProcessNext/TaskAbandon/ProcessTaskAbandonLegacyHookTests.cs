...
public class ProcessTaskAbandonLegacyHookTests
{
    private static ProcessEngineCommandContext CreateContext(Instance instance)
    {
        ...
        return new ProcessEngineCommandContext
        {
            ...
            {
                CommandKey = ProcessTaskAbandonLegacyHook.Key,
    ...
    private static ProcessTaskAbandonLegacyHook CreateCommand(params IProcessTaskAbandon[] handlers)
    {
        ...
        return new ProcessTaskAbandonLegacyHook(sp);
    }
