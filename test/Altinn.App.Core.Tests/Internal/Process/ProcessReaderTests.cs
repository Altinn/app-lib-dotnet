...
public class ProcessReaderTests
{
    ...
    // [Fact]
    // public void GetElementInfo_returns_correct_info_for_old_ProcessTask()
    // {
    //     var bpmnfile = "simple-linear.bpmn";
    //     var currentElement = "Task1";
    //     ProcessReader pr = ProcessTestUtils.SetupProcessReader(bpmnfile);
    ...
    //
    // [Fact]
    // public void GetElementInfo_returns_correct_info_for_new_ProcessTask()
    // {
    //     var bpmnfile = "simple-linear-new.bpmn";
    //     var currentElement = "Task1";
    //     ProcessReader pr = ProcessTestUtils.SetupProcessReader(bpmnfile);
    //     var actual = pr.GetElementInfo(currentElement);
    //     actual.Should().BeEquivalentTo(new ElementInfo()
    ...
    //         AltinnTaskType = "data",
    //         ElementType = "Task",
    //         AltinnTaskActions = new List<string>()
    //         {
    //             "submit"
    //         }
    //     });
    ...
    //
    // [Fact]
    // public void GetElementInfo_returns_correct_info_for_ProcessTask_prefers_new()
    // {
    //     var bpmnfile = "simple-linear-both.bpmn";
    //     var currentElement = "Task2";
    //     ProcessReader pr = ProcessTestUtils.SetupProcessReader(bpmnfile);
    //     var actual = pr.GetElementInfo(currentElement);
    //     actual.Should().BeEquivalentTo(new ElementInfo()
