...
public class AuthenticatedTests
{
    ...
    public static TheoryData<string, JwtTokenTypes, TokenIssuer, bool, bool> Tokens =>
        new()
        {
            {
            ...
            },
            {
                ...
                JwtTokenTypes.SelfIdentifiedUser,
                TokenIssuer.Altinn,
                false,
                true
            },
