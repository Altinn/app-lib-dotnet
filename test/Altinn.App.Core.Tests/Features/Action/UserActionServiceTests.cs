...
public class UserActionServiceTests
{
    ...
    {
        IUserActionService userActionService = new UserActionService(new UserActionFactory(new List<IUserAction>()));
    ...
    {
        IUserActionService userActionService = new UserActionService(new UserActionFactory(new List<IUserAction>() { new DummyUserAction(), new DummyUserActionWithValidationGroup() }));
