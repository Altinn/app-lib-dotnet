...
public class DataController : ControllerBase
{
    ...
    )
    {
        try
        {
            ...
            if (DataElementAccessChecker.GetReaderProblem(instance, dataTypeObject, User) is { } accessProblem)
            {
    ...
    )
    {
        try
        {
            ...
            if (DataElementAccessChecker.GetUpdateProblem(instance, dataTypeObject, User) is { } accessProblem)
            {
                return Problem(accessProblem);
            }
    ...
    )
    {
        try
        {
            ...
            if (
                DataElementAccessChecker.GetDeleteProblem(instance, dataTypeObject, dataGuid, User) is { } accessProblem
            )
            {
                return Problem(accessProblem);
            }
