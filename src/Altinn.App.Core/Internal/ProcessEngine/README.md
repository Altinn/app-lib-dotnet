...
Then:
1. **Register payload in `CommandPayloadJsonContext`** (`Commands/_Base/CommandPayload.cs`) - Add `[JsonSerializable(typeof(MyCommandPayload))]` for AOT-compatible source generation.
