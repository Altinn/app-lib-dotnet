...
public class ProcessReader : IProcessReader
{
    ...
    //     {
    //         elementInfo.AltinnTaskType = task.ExtensionElements?.AltinnProperties?.TaskType ?? task.TaskType;
    //         elementInfo.AltinnTaskActions = task.ExtensionElements?.AltinnProperties?.AltinnActions?.ConvertAll(a => a.Id);
    //     }
    //
    //     return elementInfo;
    // }
