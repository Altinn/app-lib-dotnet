...
namespace Altinn.App.Core.Internal.Process
{
    ...
    //                         await task.HandleTaskStart(processChangeContext.Instance.Process.CurrentTask.ElementId, processChangeContext.Instance, processChangeContext.Prefill);
    //                         break;
    //                     case InstanceEventType.process_EndTask:
    //                         await task.HandleTaskComplete(processChangeContext.Instance.Process.CurrentTask.ElementId, processChangeContext.Instance);
    //                         break;
    //                     case InstanceEventType.process_AbandonTask:
    //                         await task.HandleTaskAbandon(processChangeContext.Instance.Process.CurrentTask.ElementId, processChangeContext.Instance);
