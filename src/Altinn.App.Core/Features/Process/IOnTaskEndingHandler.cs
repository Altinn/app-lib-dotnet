...
public interface IOnTaskEndingHandler
{
    ...
    public Task<OnTaskEndingHandlerResult> ExecuteAsync(OnTaskEndingHandlerContext context);
}
...
/// </summary>
public abstract class OnTaskEndingHandlerResult : TaskHookResult { }

/// <summary>
/// Represents a successful end task hook execution.
/// </summary>
public sealed class SuccessfulOnTaskEndingHandlerResult : OnTaskEndingHandlerResult { }

/// <summary>
/// Represents a failed end task hook execution.
/// </summary>
public sealed class FailedOnTaskEndingHandlerResult : OnTaskEndingHandlerResult
{
    /// <summary>
